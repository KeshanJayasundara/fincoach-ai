    ...
    <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl z-10 w-full max-w-sm p-6">
        ...
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            className="flex-1 py-2.5 text-[12px] font-semibold text-[#4A4568] border border-[#D1CCFF] rounded-xl hover:bg-[#F8F7FF] transition-colors"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="flex-1 py-2.5 text-[12px] font-semibold text-white bg-red-500 hover:bg-red-600 rounded-xl transition-colors"
          >
            Delete
          </button>
        </div>
    ...
    >
      ...
      <div className="relative w-full sm:max-w-md bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden z-10">
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-4 border-b border-[#EAE8FB]">
          ...
          <button onClick={onClose} className="w-8 h-8 flex items-center justify-center rounded-lg border border-[#EAE8FB] text-[#8B87A8] hover:text-[#1A1635] hover:border-[#C7C3F8] transition-colors text-sm">
            ✕
          </button>
        </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            <label className="text-[11px] font-bold text-[#8B87A8] uppercase tracking-wider mb-1.5 block">Add Amount</label>
          ...
          <div>
            <label className="text-[11px] font-bold text-[#8B87A8] uppercase tracking-wider mb-1.5 block">Progress Preview</label>
            <div className="bg-[#EEF0FD] rounded-xl p-3">
              <div className="flex justify-between text-[12px] mb-2">
                <span className="text-[#4A4568]">
                  LKR {addAmount ? (goal.currentAmount + parseFloat(addAmount || "0")).toLocaleString() : goal.currentAmount.toLocaleString()}
                </span>
